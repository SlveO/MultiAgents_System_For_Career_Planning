...
# Shared strict-JSON schema text. Kept as a plain constant so the feedback
# prompt (feedback_prompt.py) reuses the exact same output contract instead
# of drifting into a parallel schema. Changing this text bumps the prompt
# version above.
...
# Core quality requirements shared by planning and feedback prompts.
PLANNING_REQUIREMENTS_TEXT = """1. 方向(target_roles)、差距(gap_analysis)、阶段行动(roadmap_30_90_180)必须齐全且相互呼应;
