...
- `architecture.md`: implemented MVP, target research system, repository
  boundaries, and CPU/GPU/L20 execution profiles.
- `interfaces.md`: canonical schemas, component contracts, error behavior,
...
- `progress.zh-CN.md`: Chinese team-facing progress and the authoritative
  2026-08-20 to 2026-08-21 handoff plan.
